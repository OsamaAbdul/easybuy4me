...
import { Cancel01Icon, TwitterIcon, Linkedin02Icon } from '@hugeicons/core-free-icons';
...
export const FooterTapedDesign = () => {
  ...
  const [modalState, setModalState] = useState<{ isOpen: boolean, type: 'terms' | 'cookies' | 'security' | 'about' | 'privacy' | 'contact' | null }>({ isOpen: false, type: null });
  ...
  const getModalContent = () => {
    switch (modalState.type) {
          ...
          content: (
            <div className="space-y-6">
              <div>
                ...
                <p>By accessing and using EasyBuy4Me, you accept and agree to be bound by the terms and provision of this agreement.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">2. Description of Service</h3>
                <p>EasyBuy4Me provides users with access to a rich collection of resources, including various tools, forums, shopping services, and personalized content.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">3. User Conduct</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">4. Modifications</h3>
              ...
              <div>
                ...
                <p>Your use of EasyBuy4Me is subject to our Privacy Policy. Please review our Privacy Policy, which also governs the Site and informs users of our data collection practices.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">6. Intellectual Property</h3>
                <p>All content included as part of the Service, such as text, graphics, logos, images, as well as the compilation thereof, is the property of EasyBuy4Me or its suppliers and protected by copyright and other laws.</p>
              </div>
            </div>
          )
        };
        ...
        return {
          ...
          content: (
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Disabling Cookies</h3>
                <p>You can prevent the setting of cookies by adjusting the settings on your browser (see your browser Help for how to do this). Be aware that disabling cookies will affect the functionality of this and many other websites that you visit.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">The Cookies We Set</h3>
      ...
      case 'security':
        return {
          ...
          content: (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Our Commitment to Security</h3>
                <p>At EasyBuy4Me, security is our top priority. We employ industry-standard security measures to ensure that your data and transactions are protected at all times.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Data Encryption</h3>
                <p>All sensitive information transmitted between your browser and our servers is encrypted using Secure Socket Layer (SSL) technology. We also encrypt sensitive data at rest using AES-256 encryption.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Payment Security</h3>
                <p>We do not store your full credit card information on our servers. All payment processing is handled by PCI-DSS compliant third-party payment processors.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Account Protection</h3>
                <p>We recommend enabling Two-Factor Authentication (2FA) for your account to add an extra layer of security. We also monitor for suspicious login attempts and will notify you of any unusual activity.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Vulnerability Reporting</h3>
                <p>If you believe you have discovered a vulnerability in our service, please contact our security team immediately at security@easybuy4me.com. We investigate all reported vulnerabilities.</p>
              </div>
            </div>
          )
        };
      case 'about':
        return {
          title: "About EasyBuy4Me",
          content: (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Our Mission</h3>
                <p>EasyBuy4Me was founded on a simple principle: to empower consumers with the freedom to shop globally and pay seamlessly.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Who We Are</h3>
                <p>We are a team of passionate technologists, financial experts, and retail enthusiasts dedicated to breaking down the barriers of international commerce.</p>
              </div>
            </div>
          )
        };
          ...
          content: (
            <div className="space-y-6">
              <div>
                ...
                <p>We collect information you provide directly to us, such as when you create or modify your account, request services, or contact customer support.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">How We Use Information</h3>
                <p>We use the information we collect to provide, maintain, and improve our services, as well as to personalize your experience and send you relevant communications.</p>
              </div>
            </div>
          )
        };
          ...
          content: (
            <div className="space-y-6">
              <div>
                ...
                <p>Have questions or need assistance? Our support team is here to help you 24/7.</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Customer Support</h3>
                <p>Email: support@easybuy4me.com<br />Phone: +1 (800) 123-4567</p>
              </div>
              <div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Corporate Headquarters</h3>
                <p> No. 120 Dan Tsoho plaza custom line, Makurdi Rd, opposite Hansuidah <br />filling station, Lafia 950101, Nasarawa State, Nigeria</p>
              </div>
            </div>
          )
        };
  ...
  return (
    <>
      <footer className="w-full bg-white relative z-20 py-16">
        <div className="relative bg-white rounded-3xl max-w-7xl mx-auto px-4 py-12 flex flex-col md:flex-row justify-between items-center gap-6 shadow-2xl border border-gray-100">
          ...
          <div className="flex flex-col md:flex-row items-start justify-between w-full gap-8 md:gap-16 px-4 md:px-12">

            {/* Brand Column */}
            <div className='flex flex-col items-start gap-6 max-w-sm'>
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 bg-[#0F1113] rounded-xl flex items-center justify-center overflow-hidden">
                  <img src="/easybuy4me-logo.jpg" alt="EasyBuy4Me Logo" className="w-full h-full object-contain" />
                </div>
                <span className="text-2xl font-bold tracking-tight text-[#1A1C1E]"><span className="text-brand-primary">EASYBUY4ME</span></span>
              </div>
              ...
              <div className="flex items-center gap-4 pt-2">
                ...
                <a href="https://x.com/EasyBuy4Me_" className="p-2.5 rounded-full bg-gray-50 hover:bg-brand-primary/10 hover:text-brand-primary transition-colors text-gray-500 border border-gray-100">
                  <HugeiconsIcon icon={TwitterIcon} size={20} strokeWidth={2} />
                </a>
                <a href="#" className="p-2.5 rounded-full bg-gray-50 hover:bg-brand-primary/10 hover:text-brand-primary transition-colors text-gray-500 border border-gray-100">
                  <HugeiconsIcon icon={Linkedin02Icon} size={20} strokeWidth={2} />
                </a>

              </div>
            </div>

            <div className='flex flex-col sm:flex-row w-full md:w-auto gap-12 md:gap-24 items-start'>

              {/* Product Column */}
              <div className='flex flex-col gap-4'>
                <h4 className='uppercase font-bold tracking-wider text-sm text-[#1A1C1E]'>Product</h4>
                <div className="flex flex-col gap-3 text-sm items-start">
                  <a className='text-gray-500 hover:text-brand-primary font-medium transition-colors' href="#">Features</a>
              ...
              {/* Company Column */}
              <div className='flex flex-col gap-4'>
                <h4 className='uppercase font-bold tracking-wider text-sm text-[#1A1C1E]'>Company</h4>
                <div className="flex flex-col gap-3 text-sm items-start">
                  <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'about' }); }} className='text-gray-500 hover:text-brand-primary font-medium transition-colors text-left'>About Us</button>

                  <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'privacy' }); }} className='text-gray-500 hover:text-brand-primary font-medium transition-colors text-left'>Privacy Policy</button>
                  <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'contact' }); }} className='text-gray-500 hover:text-brand-primary font-medium transition-colors text-left'>Contact</button>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 px-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400 font-medium border-t border-gray-100 pt-8">
          <p className="whitespace-nowrap">
            © {currentYear} EASYBUY4ME. All rights reserved.
          </p>
          <div className="flex gap-8">
            <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'terms' }); }} className="hover:text-[#1A1C1E] transition-colors">Terms of Service</button>
            <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'cookies' }); }} className="hover:text-[#1A1C1E] transition-colors">Cookies</button>
            <button onClick={(e) => { e.preventDefault(); setModalState({ isOpen: true, type: 'security' }); }} className="hover:text-[#1A1C1E] transition-colors">Security</button>
          </div>
        </div>
      </footer>
        ...
        >
          ...
          >
            <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-white">
              <h2 className="text-2xl font-bold text-[#1A1C1E]">{modalData.title}</h2>
              <button
                onClick={() => setModalState({ isOpen: false, type: null })}
            ...
            <div className="p-8 overflow-y-auto text-gray-600 bg-white">
              {modalData.content}
            </div>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50 flex justify-end">
              <button
                onClick={() => setModalState({ isOpen: false, type: null })}
                className="px-8 py-3 bg-[#1A1C1E] text-white font-medium rounded-xl hover:bg-brand-primary transition-colors"
              >
                Close
              </button>
            </div>
